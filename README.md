...
- **Prometheus-1**: Scrapes metrics and stores time series data.
- **Prometheus-2**: Another Prometheus instance for high availability.
...
- `prometheus1_config`: Stores the configuration for Prometheus-1.
- `prometheus1_data`: Stores data for Prometheus-1.
- `prometheus2_config`: Stores the configuration for Prometheus-2.
- `prometheus2_data`: Stores data for Prometheus-2.
